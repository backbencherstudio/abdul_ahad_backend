...
export class AdminNotificationService {
  ...
  async getAdminNotifications(
    ...
    // Format response with semantic data
    const formattedNotifications = notifications.map((notif) => ({
      id: notif.id,
      type: notif.notification_event?.type || 'UNKNOWN',
      message: notif.notification_event?.text || 'No message',
      metadata: notif.notification_event?.actions || {},
